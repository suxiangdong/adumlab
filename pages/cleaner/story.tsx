  ...
  return (
    <Layout>
      ...
      <div className="section section--story section--01 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            <h2 className="section__title">デザインチーム、困る</h2>
            <p className="section__txt">
              2018年の年末、バルミューダのデザインチームは困っていました。バルミューダの次の製品ジャンルを確立すべし、という任務に対して具体的なアイディアを出せていなかったからです。私が一人で創業し、自宅の机の上で製品を組み立て始めたのは17年前のこと。あれから様々な出来事が起こりましたが、中でも思い出深いのは2010年に発売した扇風機GreenFanです。バルミューダを家電メーカーへと導いてくれた記念すべき商品でした。
              <br />
              <br />
              そして次に思い出深いのは2015年に発売したBALMUDA The
              Toaster。これら二つの商品はそれぞれ、空調家電、キッチン家電と、私たちにとって重要な二つの製品ジャンルを切りひらきました。そろそろです。経営的に見ると、そろそろ次の製品ジャンルを確立しなければなりません。新ジャンルの、今後数年にわたるラインナップ案と、第一弾商品の具体案を出すこと。他ならぬ社長（私です）の指示が、開発、セールス、マーケティングの各部署に下されました。こんな時、先陣を切るのがデザインチームの役目。そして私は兼務するデザインチームの長として、困っていました。
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section section--story section--02 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            ...
            <p className="section__txt">
              掃除機を作ってくれ。全社的には、そんな声が圧倒的でした。これは以前からバルミューダに期待されていたことの一つです。そんなことはデザインチームは分かっています。分かっちゃいるけど、やらなかったのは。私自身が、「クイックルワイパー
              <sup>*1</sup>
              」の方が便利だと思っていたから。掃除って、部屋がキレイになればいいんですよね？さっと使える方が便利じゃないですか？仕上がり品質を比べると掃除機の方が圧倒的に上です。なのに、掃除機をかけるのって、やたら億劫なのです。なぜなのでしょう。
              <br />
              <br />
              「クイックルワイパー<sup>*1</sup>
              」と比べて掃除機は、仕上がり品質、時間の双方で勝っているはず。では、どこで劣っているかというと、掃除機そのものを出してくる手間、それと、操作性ではないでしょうか。なにしろ、掃除機は前後にしか動かせないのですから。この二つが私の億劫さの原因なのだとしたら、それを排除すればいいのかもしれない。つまり、出してくるどころか、最初から置いておける美しさを持ち、思い通りに動かせる操作性があればいいのではないか。あの時期、業務上の責任から、私は初めて掃除機のことを真剣に考えていました。
            </p>
      ...
      <div className="section section--story section--03 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            ...
            <p className="section__txt">
              次の日。数名のデザイナーとエンジニアを呼び、ランチをとりながら相談をしました。場所は、三河屋。私がいつも昼食をとっている近所のお蕎麦屋さんです。「掃除機について。掃除を始めるまでの心理的距離と運動エネルギーを最小にし、かつ、自在に操れるクリーナーって、作れないかな？」エンジニアには、このように科学的なオーダーをかけた方が早いのです。そして私は続けて言いました。「つまり、デザインと、技術のジャンプが必要なんだけど」バルミューダのエンジニアには、この一言は効きます。私の目論見通り。早速、現在のクリーナーの弱点、それがなぜなのか、どういう解決策が考えられるかなどなど、活発な議論が始まっていました。
              <br />
              <br />
              思えば、BALMUDA The
              Cleanerの仕様は、あの時の三河屋で決まっていたのだと思います。デュアルブラシ、ユニバーサルジョイントなどのアイディアは、お蕎麦屋さんの小さなテーブルの上ですでに語られていました。そして同日、私も社長として、新ジャンルは掃除機で行こうと決めていました。なぜって、こんなに面白そうにしている人たちを放っておくことはできないからです。結局、あの日に召集されたメンバーが、期待というプレッシャーの下で、クリーナーのコンセプトメイキングを担うことになりました。それは、頭をひねり、手作りの試作品を作り、様々な実験を行う日々を送るということです。三河屋のあの日、寒かったので、皆に鍋焼きうどんをご馳走しましたが、おそらく、日本で一番高くついた鍋焼きうどんだったと思います。
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section section--story section--06 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            <h2 className="section__title">使っていない時間の方が長い</h2>
            <p className="section__txt">
              ...
              <br />
              <br />
              技術構想が進む中、デザインチームも並走しました。外観は、シンプル、かつクリーンであることを心がけましたが、最も重要だったのは、サイクロン吸引部を下に配置したことでしょう。重心が高いものは、見るだけで不安定さを感じさせます。逆にいうと、何かをデザインする際には、重心を低くとるほうが自然なプロポーションになります。
              <br />
              <br />
              こだわったのは、充電スタンド。本体をそこにセットすると、操作スティックの先端が壁に接触するギリギリの角度で、少しだけ後ろに傾きます。なぜなら、その角度が最も自然で美しいから。何しろクリーナーは、使っている時間より、使っていない時間の方が圧倒的に長いのですから。
            </p>
            <p className="section__txt caution">
