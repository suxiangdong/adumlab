      ...
      <div className="section section--story section--01 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            ...
            <p>
              小さい頃から親しんできたスキー。今は年に数回、長野県の戸隠エリアに通っています。行きつけのロッジの雰囲气は家庭的で、夕食ができると、奥さんが食堂の入り口についている大きな鈴を鳴らして私たち宿泊客に教えてくれます。前日の夜中から明け方にかけてに雪が降った後のゲレンデ頂上からの滑り心地は最高。新鮮なパウダースノーの上を、まさに滑るように降りていくことができます。一日中滑って疲れた身体でおいしい料理を食べ、少し多めのアルコールを飲み、ラウンジでくつろぎながら山の本を読んでいると、幸せしか感じません。
              <br />
              それにしても、なぜこのラウンジは、こんなに居心地がいいんだろう？　観察してみると、灯りが違うことに气が付きました。大きな照明はなく、一つ一つは少し暗めの灯りがたくさん置かれていることで、本を読める明るさと、心を落ち着ける暗さが両立されていました。落ち着く夜には、いつもそばに、ほのかな灯りがありました。
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section section--story section--05 scrollLoader lazyload loaded">
        ...
        <div className="viewport scrollLoader fadeInUp loaded">
          <div className="__content">
            ...
            <p>
              『インターステラー』という素晴らしい映画があります。人類を救うために選ばれたクルーが、彷徨うように浮かぶ宇宙船の中で不安にかられ、録音されたコオロギの鳴き声を聞いて深く落ち着くシーンが印象的です。そのシーンに感化された私たち開発チームは、ランタン本体からコオロギの鳴き声を鳴らすという、後から考えると馬鹿げたアイデアを試します。これを実現するために、あるデザイナーは秋の間中、自宅でコオロギを飼って夜な夜なその鳴き声を録音しました。しかしこの案を実現するためには、音声を記録するメモリやマイコン、スピーカーなども必要になり、コストが上がってしまいます。結局、不採用になったこのアイデア。その理由はコストではありませんでした。音声があまりにもリアルすぎて、あたかも部屋のどこかにコオロギがいる气がするのです。つまり、落ち着くというよりむしろ、心配になるという作用が確認されたための不採用でした。
            </p>
            <p>
