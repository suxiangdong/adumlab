      ...
      <div className="section section--story section--00">
        ...
        <div className="viewport">
          <div className="__content">
            ...
            <p>
              BALMUDA电烤箱从灵感原点的那次体验到开发完成，经历了近20年的时间。由一个想法开始开发产品，途中也经历了各种意外的发现。在第一线见证了这一切的我，来为您介绍。
            </p>
        ...
        <div className="viewport scrollLoader fadeInUp lazyload">
          <div className="__content">
            ...
            <p>
              ...
              那时候，研究心旺盛的开发团队带来了面包，放在肉旁边烤。那个吐司的美味堪称完美，表面酥脆内部水分没有流失。如果能实现这个效果，就是巴慕达电烤箱的成功了！
      ...
      <div className="section section--story section--03 scrollLoader lazyload">
        ...
        <div className="viewport scrollLoader fadeInUp lazyload">
          <div className="__content">
            ...
            <p>
              这一次，协助BALMUDA电烤箱研究开发的，是吉祥寺一间每天大排长队的面包屋【ダンディゾン】。开发团队在开店前拜访，尝试了刚出炉面包的惊艳美味，并在厨房进行了学习。在那里我们见到了与以往的煤气窑炉不同的，带有蒸汽，并可以细致控制火力的电力窑炉。我们被店家烤出真正美味面包的努力所震惊，同时，也对我们自己的创意有了自信。
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="viewport scrollLoader fadeInUp lazyload">
          <div className="__content">
            ...
            <p>
              ...
              这一次我们研究的课题是，“非常美味的东西，应该从怎么样的地方孕育出来呢？”恐怕不仅仅是需要新颖，还需要有一些隐约的怀旧感，再加上一些巴慕达独有的特色。
              从诸多创意中选择了几个符合主题的，再围绕它们去延展创意。终于选定了基础方案，结合技术团队的步调，细致到每一个螺丝的大小和位置都要一一研究确定。
              这一次，设计团队为了BALMUDA电烤箱制作的草稿与模型，共计大约2000稿。
            </p>
          </div>
        </div>
      </div>
